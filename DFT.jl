...
# ╔═╡ 12dc5bb7-b046-4bb4-8653-86f61b19b77a
using WAV, FFTW, Plots, PlutoUI, LaTeXStrings, OffsetArrays

# ╔═╡ fbd31831-c7a3-4ef1-b73a-ad0bbb6512f8
md"""
### Discrete Fourier Transform

Following Grant Sanderson's [MIT Lecture](https://www.youtube.com/watch?v=g8RkArhtCc4&t=804s)

"""

# ╔═╡ 90477f5a-24c5-4a98-a778-6f31365db411
begin
	files = download.([
...
# ╔═╡ e102f584-bfb0-42d5-9083-03c9de002f77
begin
	sounds = wavread.(files)
	signals = [sound[1][:, 1] for sound in sounds]
end

# ╔═╡ d780a737-fa0a-41ba-92c0-e360d4fd707b
begin
...
# ╔═╡ 5eb340e1-dee6-4b39-a040-66d7578567dd
plot(signals[5], x_lims=(20000, 22000), label="Combined")

# ╔═╡ 3a06054c-4ede-4054-aa6c-e138f7ff97a9
signal_ffts = fft.(signals)

# ╔═╡ 4dfa1557-fe07-41f6-af5a-02439f7ac7cf
begin
...
# ╔═╡ 3e828407-6220-404e-81de-97a3f02afd6f
plot(abs.(signal_ffts[5]), x_lims=(1, 1000), label="Combined", title="Frequency Spectrum")

# ╔═╡ 5f645c94-2f72-446f-a7e9-edc0ab91d9db
@bind N Slider(1:4)

# ╔═╡ 4d803d3d-a170-45aa-9cca-189891b9d869
begin
	ts = range(1, 4)
	scatter([ℯ^(im*2π/N)], x_lims=(-1.5, 1.5), y_lims=(-1.5, 1.5), label=L"e^{2\pi i/N}")
	plot!(size=(400,400))
	plot!([(x + im*(√(1-x^2))) for x in range(-1, 1, 100)], color="red", alpha=0.5, label="")
	plot!([(x - im*(√(1-x^2))) for x in range(-1, 1, 100)], color="red", alpha=0.5, label="")
	scatter!([0 + im*0], label="")
end

# ╔═╡ ffdffd39-f7c4-4947-9c1b-9318c5fcb25b
html"""
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/mkGsMWi_j4Q?si=WqZWP6AImJxXUSPB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
"""

# ╔═╡ af3082e8-afe0-4647-b1b7-fa3b9cbcb0a5
md"""
#### Writing our own DFT function!
"""

# ╔═╡ d4bab441-27f0-4791-bf94-d0d02e2471d6
function DFT(signal)
	N = length(signal)
	# zeta = exp(-2π * im / N)
...
# ╔═╡ 6dcab103-61b5-47ab-9800-79474acf1937
signal = signals[1][1:10000]

# ╔═╡ b75f309a-c152-4664-8123-b0f9353af3e1
signal_dft = DFT(signal)

# ╔═╡ 7424bcfc-1363-4295-b194-00b121b5a3d1
